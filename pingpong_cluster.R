...
p=c(DIRECTORY,"/",LIB,"_",CHR,"_",CHR_START,"_",CHR_END,"_genome-unique.pingpong.plus_5end.minus_5end.pdf")
...
### calculate the Z-score of pingpong linkage
...
t=c(DIRECTORY,"/",LIB,"_",CHR,"_",CHR_START,"_",CHR_END,"_genome-unique.pingpong.plus_5end.minus_5end.table")
tname=paste(t,collapse="")
write.table(sum_offset3, file=tname, quote=F, row.names=F)
### 5'plus-5'minus pingpong --- END ---
