...
### use together with ${scripts}/Aedes_aegypti.sh, ${scripts}/Anopheles_stephensi, ${scripts}/Tetragonula_carbonaria.sh, ${scripts}/Acheta_domesticus.sh, and ${scripts}/Teleogryllus_oceanicus.sh
...
mainname="pingpong, plus_3end vs plus_5end"
p=c(DIRECTORY,"/",LIB,"_",TE,"_3MM_mappers.pingpong.plus_3end.plus_5end.pdf")
pname=paste(p,collapse="")

### downstream is on the left in the plot.
...
#### calculate the Z-score of Brennecke linkage
...
t=c(DIRECTORY,"/",LIB,"_",TE,"_3MM_mappers.pingpong.plus_3end.plus_5end.table")
tname=paste(t,collapse="")
write.table(sum_offset3, file=tname, quote=F, row.names=F)
### 3'plus-5'plus pingpong --- END ---
